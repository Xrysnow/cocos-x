                                                ...
                                                , csmBool invertedMask)
{
    ...
    if (renderer->GetClippingContextBufferForMask() != NULL) // マスク生成時
    {
        ...
        // 頂点配列の設定
        programState->setVertexAttrib("a_position", shaderSet->AttributePositionLocation, cocos2d::backend::VertexFormat::FLOAT2, 0, false);
        // テクスチャ頂点の設定
        programState->setVertexAttrib("a_texCoord", shaderSet->AttributeTexCoordLocation, cocos2d::backend::VertexFormat::FLOAT2, sizeof(csmFloat32) * 2, false);
