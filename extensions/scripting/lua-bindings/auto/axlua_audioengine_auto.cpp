...
int lua_ax_audioengine_AudioEngine_lazyInit(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::lazyInit();
...
int lua_ax_audioengine_AudioEngine_setCurrentTime(lua_State* tolua_S)
{
    ...
    if (argc == 2)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::setCurrentTime(arg0, arg1);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_getVolume(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getVolume(arg0);
...
int lua_ax_audioengine_AudioEngine_getMaxAudioInstance(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getMaxAudioInstance();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_isEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::isEnabled();
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_getCurrentTime(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getCurrentTime(arg0);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_setMaxAudioInstance(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::setMaxAudioInstance(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_isLoop(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::isLoop(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_play2d(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::play2d(arg0);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    if (argc == 2)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::play2d(arg0, arg1);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    if (argc == 3)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::play2d(arg0, arg1, arg2);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    if (argc == 4)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::play2d(arg0, arg1, arg2, arg3);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_getDuration(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getDuration(arg0);
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
...
int lua_ax_audioengine_AudioEngine_getDefaultProfile(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getDefaultProfile();
...
int lua_ax_audioengine_AudioEngine_getPlayingAudioCount(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::AudioEngine::getPlayingAudioCount();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
