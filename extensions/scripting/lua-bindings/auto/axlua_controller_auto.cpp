...
int lua_ax_controller_Controller_getControllerByDeviceId(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::Controller::getControllerByDeviceId(arg0);
...
int lua_ax_controller_Controller_getControllerByTag(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::Controller::getControllerByTag(arg0);
        object_to_luaval<cocos2d::Controller>(tolua_S, "cc.Controller",(cocos2d::Controller*)ret);
        return 1;
    }
...
int lua_ax_controller_EventListenerController_create(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::EventListenerController::create();
