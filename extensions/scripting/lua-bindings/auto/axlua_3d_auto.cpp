...
int lua_ax_3d_Animate3D_getTransitionTime(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::Animate3D::getTransitionTime();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
...
int lua_ax_3d_Mesh_draw(lua_State* tolua_S)
{
    ...
    if (argc == 8) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 9,&arg7, "cc.Mesh:draw");
        if(!ok)
        {
...
int lua_ax_3d_MeshRenderer_getMaterial(lua_State* tolua_S)
{
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshRenderer:getMaterial",argc, 0);
    return 0;
...
int lua_ax_3d_MeshRenderer_setWireframe(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "cc.MeshRenderer:setWireframe");
        if(!ok)
        {
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshRenderer:setWireframe",argc, 1);
    return 0;
...
int lua_ax_3d_MeshRenderer_isWireframe(lua_State* tolua_S)
{
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshRenderer:isWireframe",argc, 0);
    return 0;
...
int lua_ax_3d_MeshRendererCache_removeAllMeshRenderData(lua_State* tolua_S)
{
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshRendererCache:removeAllMeshRenderData",argc, 0);
    return 0;
...
int lua_ax_3d_MeshRendererCache_removeMeshRenderData(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string_view(tolua_S, 2,&arg0, "cc.MeshRendererCache:removeMeshRenderData");
        if(!ok)
        {
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.MeshRendererCache:removeMeshRenderData",argc, 1);
    return 0;
...
int lua_ax_3d_MeshRendererCache_getInstance(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::MeshRendererCache::getInstance();
...
int lua_ax_3d_MeshMaterial_createWithFilename(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::MeshMaterial::createWithFilename(arg0);
...
int lua_ax_3d_MeshMaterial_createWithProgramState(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::MeshMaterial::createWithProgramState(arg0);
        object_to_luaval<cocos2d::MeshMaterial>(tolua_S, "cc.MeshMaterial",(cocos2d::MeshMaterial*)ret);
        return 1;
    }
...
int lua_ax_3d_Bundle3D_createBundle(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::Bundle3D::createBundle();
