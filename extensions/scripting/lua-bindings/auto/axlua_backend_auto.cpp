...
int lua_ax_backend_Program_getVertexLayout(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<cocos2d::backend::VertexLayout>(tolua_S, "ccb.VertexLayout",(cocos2d::backend::VertexLayout*)ret);
        return 1;
    }
...
int lua_ax_backend_Program_getBuiltinProgram(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        auto&& ret = cocos2d::backend::Program::getBuiltinProgram(arg0);
...
int lua_ax_backend_VertexLayout_setStride(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "ccb.VertexLayout:setStride");
        if(!ok)
        {
...
int lua_ax_backend_ProgramState_setVertexLayout(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_vertexLayout(tolua_S, 2, arg0, "ccb.ProgramState:setVertexLayout");
        if(!ok)
        {
...
int lua_ax_backend_ProgramState_setVertexStride(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, "ccb.ProgramState:setVertexStride");
        if(!ok)
        {
...
int lua_ax_backend_ProgramState_setVertexAttrib(lua_State* tolua_S)
{
    ...
    if (argc == 5) 
    {
        ...
        ok &= luaval_to_std_string_view(tolua_S, 2,&arg0, "ccb.ProgramState:setVertexAttrib");

        ok &= luaval_to_uint32(tolua_S, 3,&arg1, "ccb.ProgramState:setVertexAttrib");

        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ccb.ProgramState:setVertexAttrib");

        ok &= luaval_to_uint32(tolua_S, 5,&arg3, "ccb.ProgramState:setVertexAttrib");

        ok &= luaval_to_boolean(tolua_S, 6,&arg4, "ccb.ProgramState:setVertexAttrib");
        if(!ok)
        {
...
int lua_ax_backend_ProgramState_validateSharedVertexLayout(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        std::function<void (cocos2d::backend::Program *)> arg0;
...
int lua_ax_backend_Device_getInstance(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        ...
        auto&& ret = cocos2d::backend::Device::getInstance();
