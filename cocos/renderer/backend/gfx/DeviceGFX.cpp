...
Buffer* DeviceGFX::newBuffer(size_t size, size_t stride, BufferType type, BufferUsage usage)
{
...
RenderTarget* DeviceGFX::newRenderTarget(
    TargetBufferFlags rtf,
...
struct BuiltinShaderHelper
{
    ...
    BuiltinShaderHelper& attr(
        const std::string& name, VertexFormat format, bool isNormalized = false, int32_t location = -1)
    {
    ...
    BuiltinShaderHelper& texture(
        const std::string& name = "u_texture", cc::gfx::Type type = cc::gfx::Type::SAMPLER2D, uint32_t binding = 2)
    {
    ...
    BuiltinShaderHelper& name(const std::string& name)
    {
...
void DeviceGFX::initBuiltinShaderInfo()
{
    ...
    helper.set(positionColor_vert)
        .name("positionColor_vert")
    ...
    helper.set(positionTexture_vert)
        .name("positionTexture_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(positionTexture_frag).name("positionTexture_frag").texture();
    helper.set(positionTextureColor_vert)
        .name("positionTextureColor_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_color", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(positionTextureColor_frag).name("positionTextureColor_frag").texture();
    helper.set(positionTextureColorAlphaTest_frag)
        .name("positionTextureColorAlphaTest_frag")
        .uniform("u_alpha_value", Type::FLOAT)
        .texture();
    helper.set(label_normal_frag).name("label_normal_frag").uniform("u_textColor", Type::FLOAT4).texture();
    helper.set(label_distanceNormal_frag)
        .name("label_distanceNormal_frag")
        .uniform("u_textColor", Type::FLOAT4)
        .texture();
    helper.set(labelOutline_frag)
        .name("labelOutline_frag")
        .uniform("u_effectColor", Type::FLOAT4)
        .uniform("u_textColor", Type::FLOAT4)
        .uniform("u_effectType", Type::INT)
        .texture();
    helper.set(labelDistanceFieldGlow_frag)
        .name("labelDistanceFieldGlow_frag")
        .uniform("u_effectColor", Type::FLOAT4)
        .uniform("u_textColor", Type::FLOAT4)
        .texture();
    // helper.set(lineColor3D_frag).name("lineColor3D_frag");
    helper.set(lineColor3D_vert)
        .name("lineColor3D_vert")
        .attr("a_position", VertexFormat::FLOAT3)
        .attr("a_color", VertexFormat::FLOAT4)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(positionColorLengthTexture_vert)
        .name("positionColorLengthTexture_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .attr("a_color", VertexFormat::FLOAT4)
    ...
    helper.set(positionColorTextureAsPointsize_vert)
        .name("positionColorTextureAsPointsize_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_color", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .uniform("u_alpha", Type::FLOAT)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(position_vert)
        .name("position_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(layer_radialGradient_frag)
        .name("layer_radialGradient_frag")
    ...
    helper.set(grayScale_frag).name("grayScale_frag").texture();
    helper.set(CC2D_quadTexture_vert)
        .name("CC2D_quadTexture_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_color", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(CC2D_quadColor_vert)
        .name("CC2D_quadColor_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_color", VertexFormat::FLOAT4)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(CC2D_quadTexture_frag).name("CC2D_quadTexture_frag").uniform("u_color", Type::FLOAT4).texture();
    helper.set(CC2D_quadColor_frag).name("CC2D_quadColor_frag").uniform("u_color", Type::FLOAT4);
    helper.set(positionUColor_vert)
        .name("positionUColor_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .uniform("u_color", Type::FLOAT4)
        .uniform("u_MVPMatrix", Type::MAT4);
    // helper.set(positionUColor_frag).name("positionUColor_frag");
    helper.set(dualSampler_frag)
        .name("dualSampler_frag")
        .texture("u_texture", Type::SAMPLER2D, 2)
        .texture("u_texture1", Type::SAMPLER2D, 3);
    helper.set(dualSampler_gray_frag)
        .name("dualSampler_gray_frag")
        .texture("u_texture", Type::SAMPLER2D, 2)
        .texture("u_texture1", Type::SAMPLER2D, 3);
    helper.set(dualSampler_hsv_frag)
        .name("dualSampler_hsv_frag")
        .texture("u_texture", Type::SAMPLER2D, 2)
        .texture("u_texture1", Type::SAMPLER2D, 3)
    ...
    helper.set(hsv_frag)
        ...
        .uniform("u_mix_hsv", Type::MAT3)
        .uniform("u_filter_rgb", Type::FLOAT3);
    helper.set(cameraClear_vert)
        .name("cameraClear_vert")
        .attr("a_position", VertexFormat::FLOAT4)
        .attr("a_color", VertexFormat::FLOAT4)
        .attr("a_texCoord", VertexFormat::FLOAT2)
        .uniform("depth", Type::FLOAT);
    // helper.set(cameraClear_frag).name("cameraClear_frag");
    helper.set(CC3D_color_frag).name("CC3D_color_frag").uniform("u_color", Type::FLOAT4);
    ...
    if (nSpot > 0)
        helper
            .uniform("u_SpotLightSourceColor", Type::FLOAT3, nSpot)
    ...
    helper.uniform("u_AmbientLightSourceColor", Type::FLOAT3).uniform("u_color", Type::FLOAT4);
    ...
    helper.set(CC3D_colorTexture_frag).uniform("u_color", Type::FLOAT4).texture();

    helper.set(CC3D_particleTexture_frag).uniform("u_color", Type::FLOAT4).texture();

    helper.set(CC3D_particleColor_frag).uniform("u_color", Type::FLOAT4);
    ...
    helper.set(CC3D_skinPositionTexture_vert)
        ...
        .uniform("u_matrixPalette", Type::FLOAT4, SKINNING_JOINT_COUNT * 3)
        .uniform("u_MVPMatrix", Type::MAT4);
    helper.set(CC3D_skybox_frag).texture("u_Env", Type::SAMPLER_CUBE, 2).uniform("u_color", Type::FLOAT4);
    helper.set(CC3D_skybox_vert).attr("a_position", VertexFormat::FLOAT3).uniform("u_cameraRot", Type::MAT4);
