...
template<> struct std::hash<cc::gfx::ShaderInfo>
{
...
protected:
	...
	static SpirvCodes compileSpirvCodes(glslang::TProgram* tProgram, const std::vector<cc::gfx::ShaderStageFlagBit>& stages);
