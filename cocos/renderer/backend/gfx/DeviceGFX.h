...
public:
     ...
     */
    Buffer* newBuffer(size_t size, BufferType type, BufferUsage usage) override;
    Buffer* newBuffer(size_t size, size_t stride, BufferType type, BufferUsage usage) override;
