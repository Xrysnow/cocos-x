...
cc::gfx::Format UtilsGFX::toAttributeType(VertexFormat vertexFormat)
{
	...
	switch (vertexFormat)
	{
	case VertexFormat::FLOAT4: return Format::RGBA32F;
	case VertexFormat::FLOAT3: return Format::RGB32F;
	case VertexFormat::FLOAT2: return Format::RG32F;
	case VertexFormat::FLOAT: return Format::R32F;
	case VertexFormat::INT4: return Format::RGBA32I;
	case VertexFormat::INT3: return Format::RGB32I;
	case VertexFormat::INT2: return Format::RG32I;
	case VertexFormat::INT: return Format::R32I;
	case VertexFormat::USHORT4: return Format::RGBA16I;
	case VertexFormat::USHORT2: return Format::RG16I;
	case VertexFormat::UBYTE4: return Format::RGBA8;
	default:
		break;
	}
...
uint32_t UtilsGFX::getUniformStd140Alignment(cc::gfx::Type type, uint32_t count)
{
	...
	if (count == 0)
	{
		switch (type)
		{
		case cc::gfx::Type::UNKNOWN: return 0;
		case cc::gfx::Type::BOOL: return N;
		case cc::gfx::Type::BOOL2: return 2 * N;
		case cc::gfx::Type::BOOL3: return 4 * N;
		case cc::gfx::Type::BOOL4: return 4 * N;
		case cc::gfx::Type::INT: return N;
		case cc::gfx::Type::INT2: return 2 * N;
		case cc::gfx::Type::INT3: return 4 * N;
		case cc::gfx::Type::INT4: return 4 * N;
		case cc::gfx::Type::UINT: return N;
		case cc::gfx::Type::UINT2: return 2 * N;
		case cc::gfx::Type::UINT3: return 4 * N;
		case cc::gfx::Type::UINT4: return 4 * N;
		case cc::gfx::Type::FLOAT: return N;
		case cc::gfx::Type::FLOAT2: return 2 * N;
		case cc::gfx::Type::FLOAT3: return 4 * N;
		case cc::gfx::Type::FLOAT4: return 4 * N;
		case cc::gfx::Type::MAT2: return 2 * N;
		case cc::gfx::Type::MAT2X3: return 4 * N;
		case cc::gfx::Type::MAT2X4: return 4 * N;
		case cc::gfx::Type::MAT3X2: return 2 * N;
		case cc::gfx::Type::MAT3: return 4 * N;
		case cc::gfx::Type::MAT3X4: return 4 * N;
		case cc::gfx::Type::MAT4X2: return 2 * N;
		case cc::gfx::Type::MAT4X3: return 4 * N;
		case cc::gfx::Type::MAT4: return 4 * N;
		default:;
		}
		return 0;
	}
...
uint32_t UtilsGFX::getUniformStd140Size(cc::gfx::Type type, uint32_t count)
{
	...
	if (count == 0)
	{
		...
		case cc::gfx::Type::BOOL: return N;
		case cc::gfx::Type::BOOL2: return 2 * N;
		case cc::gfx::Type::BOOL3: return 3 * N;
		case cc::gfx::Type::BOOL4: return 4 * N;
		case cc::gfx::Type::INT: return N;
		case cc::gfx::Type::INT2: return 2 * N;
		case cc::gfx::Type::INT3: return 3 * N;
		case cc::gfx::Type::INT4: return 4 * N;
		case cc::gfx::Type::UINT: return N;
		case cc::gfx::Type::UINT2: return 2 * N;
		case cc::gfx::Type::UINT3: return 3 * N;
		case cc::gfx::Type::UINT4: return 4 * N;
		case cc::gfx::Type::FLOAT: return N;
		case cc::gfx::Type::FLOAT2: return 2 * N;
		case cc::gfx::Type::FLOAT3: return 3 * N;
		case cc::gfx::Type::FLOAT4: return 4 * N;
		case cc::gfx::Type::MAT2: return N4 * 2;
		case cc::gfx::Type::MAT2X3: return N4 * 2;
		case cc::gfx::Type::MAT2X4: return N4 * 2;
		case cc::gfx::Type::MAT3X2: return N4 * 3;
		case cc::gfx::Type::MAT3: return N4 * 3;
		case cc::gfx::Type::MAT3X4: return N4 * 3;
		case cc::gfx::Type::MAT4X2: return N4 * 4;
		case cc::gfx::Type::MAT4X3: return N4 * 4;
		case cc::gfx::Type::MAT4: return N4 * 4;
		default:;
		}
		return 0;
	}
	else
	{
		...
		case cc::gfx::Type::FLOAT4: return N4 * count;
		case cc::gfx::Type::MAT2: return N4 * count * 2;
		case cc::gfx::Type::MAT2X3: return N4 * count * 2;
		case cc::gfx::Type::MAT2X4: return N4 * count * 2;
		case cc::gfx::Type::MAT3X2: return N4 * count * 3;
		case cc::gfx::Type::MAT3: return N4 * count * 3;
		case cc::gfx::Type::MAT3X4: return N4 * count * 3;
		case cc::gfx::Type::MAT4X2: return N4 * count * 4;
		case cc::gfx::Type::MAT4X3: return N4 * count * 4;
		case cc::gfx::Type::MAT4: return N4 * count * 4;
		default:;
		}
		return 0;
	}
...
cc::gfx::CullMode UtilsGFX::toCullMode(CullMode mode)
{
	switch (mode)
	{
	case CullMode::NONE: return cc::gfx::CullMode::NONE;
	case CullMode::BACK: return cc::gfx::CullMode::BACK;
	case CullMode::FRONT: return cc::gfx::CullMode::FRONT;
	default:;
	}
...
cc::gfx::Format UtilsGFX::toFormat(cc::gfx::Type t)
{
	...
	switch (t)
	{
	case cc::gfx::Type::INT: return Format::R32I;
	case cc::gfx::Type::INT2: return Format::RG32I;
	case cc::gfx::Type::INT3: return Format::RGB32I;
	case cc::gfx::Type::INT4: return Format::RGBA32I;
	case cc::gfx::Type::UINT: return Format::R32UI;
	case cc::gfx::Type::UINT2: return Format::RG32UI;
	case cc::gfx::Type::UINT3: return Format::RGB32UI;
	case cc::gfx::Type::UINT4: return Format::RGBA32UI;
	case cc::gfx::Type::FLOAT: return Format::R32F;
	case cc::gfx::Type::FLOAT2: return Format::RG32F;
	case cc::gfx::Type::FLOAT3: return Format::RGB32F;
	case cc::gfx::Type::FLOAT4: return Format::RGBA32F;
	default: ;
	}
...
cc::gfx::Type UtilsGFX::toType(const glslang::TType* t)
{
	...
	if (btype != glslang::EbtSampler)
	{
		...
		else if (1 <= vsize && vsize <= 4)
		{
			switch (btype)
			{
			case glslang::EbtVoid: break;
			case glslang::EbtFloat: return (Type)((int)Type::FLOAT + vsize - 1);
			case glslang::EbtDouble: break;
			case glslang::EbtFloat16: break;
			case glslang::EbtInt8: break;
			case glslang::EbtUint8: break;
			case glslang::EbtInt16: break;
			case glslang::EbtUint16: break;
			case glslang::EbtInt: return (Type)((int)Type::INT + vsize - 1);
			case glslang::EbtUint: return (Type)((int)Type::UINT + vsize - 1);
			case glslang::EbtInt64: break;
			case glslang::EbtUint64: break;
			case glslang::EbtBool: return (Type)((int)Type::FLOAT + vsize - 1);
			case glslang::EbtAtomicUint: break;
			case glslang::EbtSampler: break;
			case glslang::EbtStruct: break;
			case glslang::EbtBlock: break;
			case glslang::EbtAccStruct: break;
			case glslang::EbtReference: break;
			case glslang::EbtRayQuery: break;
			case glslang::EbtString: break;
			case glslang::EbtNumTypes: break;
			default:;
			}
		}
	}
	else
	{
		...
		if (s.isCombined())
		{
			...
			case glslang::Esd1D: return s.isArrayed() ? Type::SAMPLER1D_ARRAY : Type::SAMPLER1D;
			case glslang::Esd2D: return s.isArrayed() ? Type::SAMPLER2D_ARRAY : Type::SAMPLER2D;
			case glslang::Esd3D: return Type::SAMPLER3D;
			case glslang::EsdCube: return Type::SAMPLER_CUBE;
			case glslang::EsdRect: break;
			case glslang::EsdBuffer: break;
			case glslang::EsdSubpass: break;
			case glslang::EsdNumDims: break;
			default: ;
			}
		}
		else if (s.isTexture())
		{
			...
			{
			case glslang::EsdNone: break;
			case glslang::Esd1D: return s.isArrayed() ? Type::TEXTURE1D_ARRAY : Type::TEXTURE1D;
			case glslang::Esd2D: return s.isArrayed() ? Type::TEXTURE2D_ARRAY : Type::TEXTURE2D;
			case glslang::Esd3D: return Type::TEXTURE3D;
			case glslang::EsdCube: return Type::TEXTURE_CUBE;
			case glslang::EsdRect: break;
			case glslang::EsdBuffer: break;
			case glslang::EsdSubpass: break;
			case glslang::EsdNumDims: break;
		...
		else if (s.isImage())
		{
			...
			{
			case glslang::EsdNone: break;
			case glslang::Esd1D: return s.isArrayed() ? Type::IMAGE1D_ARRAY : Type::IMAGE1D;
			case glslang::Esd2D: return s.isArrayed() ? Type::IMAGE2D_ARRAY : Type::IMAGE2D;
			case glslang::Esd3D: return Type::IMAGE3D;
			case glslang::EsdCube: return Type::IMAGE_CUBE;
			case glslang::EsdRect: break;
			case glslang::EsdBuffer: break;
			case glslang::EsdSubpass: break;
			case glslang::EsdNumDims: break;
	...
	int vkMinorVersion)
{
	...
	bool success = shader.parse(&DefaultTBuiltInResource,
		clientInputSemanticsVersion, isForwardCompatible, controls);
	if (!success)
	{
...
std::string UtilsGFX::compileSPIRVtoGLSL(
